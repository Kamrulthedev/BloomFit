...
const Categorie = () => {
  ...
  return (
    <div className="categories-section py-16 px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 ">
      {categories?.slice(0, 4).map((category) => (
        ...
        >
          <img
            src={category.image}
            alt={category.name}
            className="w-72 hover:p-2 h-72 object-cover  rounded-lg mb-2"
          />
